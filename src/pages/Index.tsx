          ...
          <div className="max-w-[1400px] mx-auto flex justify-end">
            <div className="max-w-xl space-y-8 pr-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button onClick={() => scrollToSection("models")} variant="outline" className="border-2 border-black bg-black text-white hover:bg-black/80 font-medium px-8 py-6 text-base opacity-95">
                  View Models
                </Button>
              </div>
            </div>
